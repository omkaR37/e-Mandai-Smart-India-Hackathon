...
$conn =mysqli_connect('localhost','root','','project') or die("Unable to connect");
 ...
 if(isset($_POST['signupbutton'])) {
	...
	$query="select * from farmer where contact='$contact'";
                  ...
                  if(in_array($filecheck,$fileextstored))
                  	{
                  		...
                  		$q ="insert into farmer(fname,lname,photo,dob,contact,altcontact,address,pin,aadhar,faddress,fpin,pass) values('$fname','$lname','$filename	','$dob','$contact','$altcontact','$address','$pin','$aadhar','$faddress','$fpin','$password')";
                    	...
                    	$q ="insert into farmer(fname,lname,dob,contact,altcontact,address,pin,aadhar,faddress,fpin,pass) values('$fname','$lname','$dob','$contact','$altcontact','$address','$pin','$aadhar','$faddress','$fpin','$password')";
                    			$query = mysqli_query($conn,$q);
                    				if($query)
    	                 	{
        	             		echo '<script type="text/javascript">  alert(" You are registered !!") </script>' ;
