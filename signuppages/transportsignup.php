...
<html>
<head>
	<title>Transport Agent Detail Page</title>
...
<body>
    <form method="post" action="transportsignup.php" enctype="multipart/form-data">
	<div id="login-box">
            <div class="photobox">
        ...
        <div class="left-box">
           	<h1>Transport Insert Information </h1>
            	...
            	<input type="text" name="licno" placeholder="Driving Lic No"  />
